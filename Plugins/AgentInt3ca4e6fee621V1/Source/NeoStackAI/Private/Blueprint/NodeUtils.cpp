...
static TArray<FNodeSearchResult> FindNodesWithBlueprintContext(const FString& Query, UBlueprint* ContextBP, UEdGraph* TargetGraph, int32 MaxResults)
{
...
TArray<FNodeSearchResult> NeoNodes::FindNodesForGraph(const FString& Query, UBlueprint* ContextBP, UEdGraph* TargetGraph, int32 MaxResults)
{
	...
	return FindNodesWithBlueprintContext(Query, ContextBP, TargetGraph, MaxResults);
}
