...
// Must use ETickableTickType::Never if initializing async. This gets set properly in PostInitProperties after construction.
USMInstance::USMInstance() : FTickableGameObject(ETickableTickType::Never)
{
...
void USMInstance::PostInitProperties()
{
	Super::PostInitProperties();
	SetTickableTickType(ETickableTickType::NewObject);
}
