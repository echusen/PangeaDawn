...
#include "ACFSkillTreeFactory.generated.h"

UCLASS()
class ASCENTSKILLTREEEDITOR_API UACFSkillTreeFactory : public UFactory {
    GENERATED_BODY()

public:
    UACFSkillTreeFactory();
    ...
    virtual FText GetDisplayName() const override { return FText::FromString("Skill Tree"); }

    /** Returns the tooltip text description of this factory */
    virtual FText GetToolTip() const override
    {
        return FText::FromString("Creates a new Skill Tree Object");
    }
